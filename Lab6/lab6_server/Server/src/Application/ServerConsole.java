    ...
    public void interactiveMod(String command) {
        ...
        switch (finalUserCommand[0]) {
            ...
            case "save":
                ...
                break;
            case "change_path":
                System.out.println("Текущий путь:" + manager.savePath);
                System.out.println("Введите путь для сохранения коллекции:");
                manager.savePath = Utils.scanner().nextLine();
                break;
            case "exit":
                try {
                    manager.save();
                }catch (NullPointerException e){
                    System.out.println("Парсинг не был выполнен, коллекция не сохранена.");
                }
                logger.info("Вы завершили работу сервера.");
                System.out.println("Вы завершили работу сервера.");
                System.exit(0);
